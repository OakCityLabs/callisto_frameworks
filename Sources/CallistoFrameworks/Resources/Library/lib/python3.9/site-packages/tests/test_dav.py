...
from .utils import (get_permissionless_token, get_read_only_token,
                    get_superuser_token, wait_for_event)
...
class TestWatchdogWebSocket:
    ...
    async def create_dir(self, websocket: WebSocket, ututils: TestCase):
        ...
        ututils.assertCountEqual([resp, resp2], [
            {
                "watchdog_event": {
                    "event_type": "created",
    ...
    async def create_file(
        self, websocket: WebSocket, ututils: TestCase,
    ...
    async def test_deleted_file(
        ...
        async with websocket_client.websocket_connect(
            ...
            ututils.assertCountEqual([resp1, resp2, resp3], expected)
    ...
    async def test_nested_updates(
        ...
        async with websocket_client.websocket_connect(
            ...
            resps = []
            for _ in expected:
                resps.append(await wait_for_event(
                    websocket,
                    "watchdog_event"
                ))
