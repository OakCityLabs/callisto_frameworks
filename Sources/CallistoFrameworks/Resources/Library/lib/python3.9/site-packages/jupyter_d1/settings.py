...
class Settings(BaseSettings):
    ...
    def get_dav_settings(
        ...
        return {
            ...
            "port": 8080,
            "mount_path": "/dav",
            "provider_mapping": {"/": root_dir, root_dir.lower(): root_dir},
            "verbose": 3,
            "http_authenticator": {
    ...
    WATCHDOG_IGNORE_PATTERNS: List[str] = [".DS_Store"]
    ...
    def get_watchdog_enabled(cls, v: bool, values: Dict[str, Any]) -> bool:
        ...
        if platform.system().startswith("Darwin"):
            return False
        return False  # temp default to False for testing watchdog/rclone
        # return True
