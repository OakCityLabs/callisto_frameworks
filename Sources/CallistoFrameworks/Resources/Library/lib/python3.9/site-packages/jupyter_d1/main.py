...
from .routers import hello, kernels, login, notebooks, rclone, server
...
def startup_event():
    ...
    if settings.RCLONE_STATS_POLL:
        ...
        loop.create_task(rclone.stats_periodic())
        loop.create_task(stats_manager.server_stats_periodic())
        rclone.start_watchdog()
